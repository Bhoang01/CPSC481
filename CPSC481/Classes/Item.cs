...
public class Item
{
	...
	public Item(int id, string name, string city, string description, string category, string address, double longitude, double latitude, double price, string[] images, int minAge, int maxAge, int people)
	{
		this.id = id;
		this.name = name;
		this.city = city;
